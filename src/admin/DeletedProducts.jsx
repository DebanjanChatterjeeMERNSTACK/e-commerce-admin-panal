...
const DeletedProducts = () => {
  ...
  const fetchItems = () => {
    fetch(`${URL}/product_get`, {
      ...
      .then((json) => {
        if (json.status == 200) {
          setData(json.product.filter((e) => e.product_Delete === 1));
        } else {
          Swal.fire({
            title: json.text,
...
const handleRestore = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`${URL}/product_restore`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
          body: JSON.stringify({ id: id, product_Delete: 0 }),
        })
          .then((res) => res.json())
          .then((data) => {
            if (data.status == 200) {
      ...
      <div className="content">
        <div className="container-fluid">
          <div className="panel_contentbox">
            <h5 className="box_title">Restore Product </h5>

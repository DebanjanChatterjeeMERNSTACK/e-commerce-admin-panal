...
const EditProduct = () => {
  ...
  const [Productverity, setproductverity] = useState([
    { Selling_price: "", Quantity: "", Units: "", Size: "" },
  ]);
  ...
  useEffect(() => {
    fetch(`${URL}/product_edit/${product_id}`)
      .then((response) => response.json())
      .then((data) => {
        if (data.status == 200) {
          setproductname(data.product.product_Title);
          setproductcatagory(data.product.product_Category);
          // setproductmainprice(data.product.product_Main_Price);
          setproductsellingprice(data.product.product_Selling_Price);
          setProductDiscount(data.product.product_Offer_Percentage);
          setproducthit(data.product.product_hit);
          setproductstock(data.product.product_Stock);
          setproductquantity(data.product.product_Quantity);
          setproductquantityunit(data.product.product_Quantity_unit);
          setproductdescription(data.product.product_Description);
          setproductverity(data.product.product_variant);
          setpreImage(data.product.product_Image);
          setproductBrand(data.product.product_Brand);
          setproductWarrantyInformation(
            data.product.product_Warranty_Information
          );
          setproductShippingInformation(
            data.product.product_Shipping_Information
          );
          setproductWeight(data.product.product_Weight);
          setproductWeightUnit(data.product.product_Weight_units);
          setcolorcode(data.product.product_color);
          setproductSKU(data.product.product_SKU);
          setproductRating(data.product.product_rating);
          setproductsubcatagory(data.product.product_Sub_Category);
          setproductseotitle(data.product.product_SEO_Title);
          setproductseodecsription(data.product.product_SEO_Description);
          setproductseokeywords(data.product.product_SEO_Keywords);
        } else {
          Swal.fire({
            title: data.text,
            icon: data.mess, // 'success', 'error', 'warning', 'info', or 'question'
      ...
      <div className="content">
        <div className="container-fluid">
          <div className="panel_contentbox">
            <h5 className="box_title">Edit Product</h5>

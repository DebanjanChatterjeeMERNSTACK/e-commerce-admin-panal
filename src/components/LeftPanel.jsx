...
const LeftPanel = ({ sidebarToggle }) => {
  ...
  return (
    <>
      <div
        className={`${
          sidebarToggle ? "menuitem_collapsed" : ""
        } left_panel leftside_menu`}
      >
              ...
              <div className="nav_accordion">
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(1) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(1) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(1) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      ...
                      <li className="side_nav_item">
                        <Link
                          ...
                          className={activeIndex === 134 ? "active" : ""}
                          onClick={() => handleClick(134)}
                        >
                          Privacy Page
                        </Link>
                      </li>
                      <li className="side_nav_item">
                        <Link
                          ...
                          className={activeIndex === 133 ? "active" : ""}
                          onClick={() => handleClick(133)}
                        >
                      ...
                      <li className="side_nav_item">
                        <Link
                          to="/admin/pages/shipping"
                          className={activeIndex === 132 ? "active" : ""}
                          onClick={() => handleClick(132)}
                        >
                          Shipping Page
                        </Link>
                      </li>
                      <li className="side_nav_item">
                        <Link
                          to="/admin/pages/refund"
                          className={activeIndex === 131 ? "active" : ""}
                          onClick={() => handleClick(131)}
                        >
                          Refund Page
                        </Link>
                      </li>
                      <li className="side_nav_item">
                        <Link
                          to="/admin/pages/faq"
                          className={activeIndex === 130 ? "active" : ""}
                          onClick={() => handleClick(130)}
                        >
                          FAQ Page
                        </Link>
                      </li>
                ...
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(2) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(2) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(2) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      <li className="side_nav_item">
                ...
                <div className="accordion_item">
                  <div
                    className={`accordionHeader ${
                      activeIndexes.includes(51) ? "active" : ""
                    }`}
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(51) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(51) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  ...
                  >
                    <ul className="side_nav_second_level">
                      ...
                      <li className="side_nav_item">
                        <Link
                          to="/admin/section/member"
                          className={activeIndex === 110 ? "active" : ""}
                ...
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(3) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(3) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(3) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      <li className="side_nav_item">
                        <Link
                          to="/admin/categories"
                          className={activeIndex === 23 ? "active" : ""}
                      ...
                      <li className="side_nav_item">
                        <Link
                          ...
                          className={activeIndex === 24 ? "active" : ""}
                      ...
                      <li className="side_nav_item">
                        <Link
                          to="/admin/restore-category"
                          className={activeIndex === 26 ? "active" : ""}
                ...
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(5) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(5) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(5) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      <li className="side_nav_item">
                      ...
                      <li className="side_nav_item">
                        <Link
                          ...
                          className={activeIndex === 19 ? "active" : ""}
                      ...
                      <li className="side_nav_item">
                        <Link
                          to="/admin/invoices"
                          className={activeIndex === 20 ? "active" : ""}
                ...
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(6) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(6) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(6) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      <li className="side_nav_item">
                        <Link
                          to="/admin/appearance/media"
                      ...
                      <li className="side_nav_item">
                        <Link
                          to="/admin/appearance/contact-form"
                ...
                <div className="accordion_item">
                  ...
                  >
                    ...
                    <span
                      className={`arrow arrow-right ${
                        activeIndexes.includes(7) ? "arrow-animate" : ""
                      }`}
                    >
                      <i
                        className={`fa-solid fa-angle-right ${
                          activeIndexes.includes(7) ? "fa-angle-down" : ""
                        }`}
                      ></i>
                    </span>
                  </div>
                  <div
                    className={`accordionBody ${
                      activeIndexes.includes(7) ? "open slide-down" : "slide-up"
                    }`}
                  >
                    <ul className="side_nav_second_level">
                      <li className="side_nav_item">
                        <Link
                          to="/admin/settings/app-setting"
                          className={activeIndex === 21 ? "active" : ""}
